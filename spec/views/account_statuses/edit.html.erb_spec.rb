...
describe "account_statuses/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit account_status form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => account_statuses_path(@account_status), :method => "post" do
